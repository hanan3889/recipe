...
class UserController extends Controller
{
    ...
    public function store(UserRequest $request)
    {
        ...
        return to_route('author.index')->with('success', 'Auteur ajouté avec succes');
    }
    ...
    public function update(UserRequest $request, User $author)
    {
        ...
        return to_route('author.index')->with('success', 'Auteur modifié avec succes');
    ...
    public function destroy(User $author)
    {
        ...
        return back()->with('success', 'Auteur supprimé avec succes');
    }
}
