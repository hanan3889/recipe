                            ...
                            <tr>
                                ...
                                <td>
                                    <h2 class="table-avatar">
                                        <a href="{{route('profile.edit')}}" class="avatar avatar-sm mr-2" >
                                            <img class="avatar-img rounded-circle" src="{{asset('back_auth/assets/profile'.$author->image) }}" alt="User Image"/></a>
                                ...
                                <td class="text-right">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <a class="dropdown-item" href="#" onclick="confirm('Etes vous certain de supprimer cet élément ?')" >
